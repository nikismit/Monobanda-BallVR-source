...
public class AudioMovement_ForPhoneInput : MonoBehaviour {
    ...
    void FixedUpdate()
    {
		...
		// void phoneControls(){
		// 	float translation = CrossPlatformInputManager.GetAxis("Vertical") * currentSpeed * Time.fixedDeltaTime;
		// 	float rotation = CrossPlatformInputManager.GetAxis("Horizontal") * turningSpeed * currentTurn * Time.fixedDeltaTime;
