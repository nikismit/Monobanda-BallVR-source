...
public class AudioMovement1 : MonoBehaviour {
    ...
    void FixedUpdate()
    {
		...
		if(currentPitch > minimumPitch){
			...
			//This one
			//this.transform.Rotate(new Vector3(0, 0, 1) * turningSpeed * currentTurn * Time.fixedDeltaTime, Space.World);
			
			calculatedTurn = turningSpeed * currentTurn * Time.fixedDeltaTime;
			
			this.transform.Rotate(new Vector3(0, 0, 1) * calculatedTurn, Space.World);
